...
## 4. Mockup minimale
Il design di base della Home Page segue lo schema allegato (`docs/home_mockup.jpg`):
...
- **Test 3 - Rete Assente durante il caricamento:** L'utente clicca su un quiz. Durante la fase di caricamento, in caso di assenza direte, il frontend deve intercettare l'errore `fetch` e mostrare un'interfaccia dedicata: "Impossibile caricare le domande. Controlla la tua connessione".
